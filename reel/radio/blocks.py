...
SEGS = [
 ...
 # Her answer. The middle of it — "בתקופה שאני הייתי רוב הזמן הזה [?] ראש עיר,
 # תמיד העלינו יועצים חיצוניים" — came back too uncertain to caption, so the
 # cut keeps the two ends that are clean and drops what could not be verified.
 ("sure",    78.24, 79.95, [(2, [
