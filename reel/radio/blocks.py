...
speaker: 1 = Yossi Hadar, 2 = Shani Greenberg.
"""
...
SEGS = [
 ...
 ("q1",     105.76, 108.90, [(1, [
    (105.82,"אבל"),(106.14,"אני"),(106.30,"רוצה"),(106.46,"להבין,"),(106.78,"שני,"),
    (107.02,"למה"),(107.26,"הקרסת"),(107.74,"שירותי"),(108.06,"העירייה?")])]),

 ("mgmt",   114.40, 125.70, [(2, [
    (114.46,"בניהול"),(115.02,"מערכות"),(115.42,"ציבוריות,"),(116.28,"כשאתה"),
 ...
 ("q2hook", 145.20, 152.02, [
   (1, [(145.26,"מה"),(145.74,"זאת"),(145.90,"אומרת"),(146.14,"מי?"),(146.46,"העירייה"),
        (147.02,"צריכה"),(147.42,"לעשות"),(147.74,"את"),(147.90,"זה?")]),
 ...
 ("hook2",  198.52, 205.20, [(2, [
    (198.58,"תראה,"),(199.06,"אני"),(199.14,"לא"),(199.30,"יודעת"),(199.46,"להסביר"),
 ...
 ("q4str", 217.70, 232.75, [
   ...
   (2, [(220.24,"אפילו"),(220.96,"בניקיון."),
        ...
        (229.01,"מה"),(229.33,"שהשתנה"),(229.81,"זה"),(230.13,"שאתה"),(230.45,"נפטר"),
        (230.93,"מהעובדים"),(231.57,"המקצועיים"),(232.29,"שלך.")])]),
